...
class CD_Survival extends KFGameInfo_Survival
	config( ControlledDifficulty_Graphite );
...
{
	BroadcastCDEcho( "[Controlled Difficulty: Graphite Edition - " $ `CD_BUILD_TYPE $ "]" $ "\n" $ ChatCommander.GetCDInfoChatString( "brief" ) );
}
...
private function MaybeLoadIniWaveInfos()
{
	if ( !AlreadyLoadedIniWaveInfos )
	{
		...
		//ConsoleCommand("reloadcfg ControlledDifficulty_Graphite.CD_Survival", true);
		//ConsoleCommand("reloadcfg 'ControlledDifficulty_Graphite.CD_Survival'", true);
		//ConsoleCommand("reloadcfg \"ControlledDifficulty_Graphite.CD_Survival\"", true);
...
defaultproperties
{
	GameConductorClass=class'ControlledDifficulty_Graphite.CD_DummyGameConductor'

	DifficultyInfoClass=class'ControlledDifficulty_Graphite.CD_DifficultyInfo'

	SpawnManagerClasses(0)=class'ControlledDifficulty_Graphite.CD_SpawnManager_Short'
	SpawnManagerClasses(1)=class'ControlledDifficulty_Graphite.CD_SpawnManager_Normal'
	SpawnManagerClasses(2)=class'ControlledDifficulty_Graphite.CD_SpawnManager_Long'

	PlayerControllerClass=class'ControlledDifficulty_Graphite.CD_PlayerController'
	...
	CDGameModes.Add((FriendlyName="Controlled Difficulty: Graphite Edition",ClassNameAndPath="ControlledDifficulty_Graphite.CD_Survival",bSoloPlaySupported=True,DifficultyLevels=4,Lengths=4,LocalizeID=0))

    	GameInfoClassAliases.Add((ShortName="CD_Survival", GameClassName="ControlledDifficulty_Graphite.CD_Survival"))
}
