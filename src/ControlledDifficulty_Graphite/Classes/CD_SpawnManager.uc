...
function GetSpawnListFromSquad(byte SquadIdx, out array< KFAISpawnSquad > SquadsList, out array< class<KFPawn_Monster> >  AISpawnList)
{
	...
	if ( !AlbinoCrawlersBool )
	{
		...
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedCrawler_Special';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedCrawler_Regular',
		                 AISpawnList );
	}
	...
	if ( !AlbinoAlphasBool )
	{
		...
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedClot_Alpha_Special';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedClot_Alpha_Regular',
		                 AISpawnList );
	}
	else
	{
		...
		MatchClasses[0] = AIClassList[AT_AlphaClot];
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedClot_Alpha',
		                 AISpawnList );
	}
	...
	if ( !AlbinoGorefastsBool )
	{
		...
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedGorefast_Special';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedGorefast_Regular',
		                 AISpawnList );
	}
	...
	if ( !AlbinoStalkersBool )
	{
		...
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedStalker_Special';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedStalker_Regular',
		                 AISpawnList );
	}
	...
	if ( !AlbinoHusksBool )
	{
		...
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedHusk_Special';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedHusk_Regular',
		                 AISpawnList );
	}
	...
	if ( !FleshpoundRageSpawnsBool )
	{
		...
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedFleshpound_RS';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedFleshpound_NRS',
		                 AISpawnList );

		// Same, but for minis
		MatchClasses.Length = 2;
		MatchClasses[0] = AIClassList[AT_FleshpoundMini];
		MatchClasses[1] = class'ControlledDifficulty_Graphite.CD_Pawn_ZedFleshpoundMini_RS';
		ReplaceZedClass( MatchClasses,
		                 class'ControlledDifficulty_Graphite.CD_Pawn_ZedFleshpoundMini_NRS',
		                 AISpawnList );
	}
}
